...
const ROOT = '/Users/agordon/.codex/sessions'
...
const REAL_CAPTURE =
  [
    ...
    'f1\0n/dev/ttys001\0',
    'f2\0n/dev/null\0',
    'f10\0n/Users/agordon/.codex/state_5.sqlite\0',
  ...
  it('a rollout copied OUTSIDE the sessions root is not the session being run', () => {
    ...
    const procs = parseOf([
      { pid: 100, command: 'zsh', files: [['0', '/dev/ttys001']] },
      {
        pid: 101,
        command: 'codex',
        files: [['0', '/dev/ttys001'], ['38', `/Users/agordon/Desktop/rollout-2026-08-04T11-25-20-${S1}.jsonl`]]
      }
    ])
    noBind(procs, [{ ptyId: 'A', shellPid: 100 }], new Set([S1]))
  })
