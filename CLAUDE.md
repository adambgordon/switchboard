...
4. `npm test` — vitest over `test/` (20 suites: main-side parser/indexer/rename/customTitle/windowState/codexParser/codexThreadsDb/codexSessionIndex/codexRename/bootCommand/updater-core + shared messageCount + renderer-lib liveness/theme/navHistory/pins/clipboard/findMatches/messageGroups/codeLang). The renderer UI is not unit-tested.
