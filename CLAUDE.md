...
4. `npm test` — vitest over `test/` (22 suites: main-side parser/indexer/rename/customTitle/windowState/codexParser/codexThreadsDb/codexSessionIndex/codexRename/codexInputNotifications/bootCommand/agentEnv/updater-core + shared messageCount + renderer-lib liveness/theme/navHistory/pins/clipboard/findMatches/messageGroups/codeLang). The renderer UI is not unit-tested.
