...
4. `npm test` — vitest over `test/` (17 suites: main-side parser/indexer/rename/customTitle/windowState/codexParser/codexThreadsDb/codexSessionIndex/codexRename/updater-core + renderer-lib liveness/theme/navHistory/pins/clipboard/findMatches/messageGroups). The renderer UI is not unit-tested.
