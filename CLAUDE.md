...
4. `npm test` — vitest over `test/` (19 suites: main-side parser/indexer/rename/customTitle/windowState/codexParser/codexThreadsDb/codexSessionIndex/codexRename/bootCommand/updater-core + renderer-lib liveness/theme/navHistory/pins/clipboard/findMatches/messageGroups/codeLang). The renderer UI is not unit-tested.
