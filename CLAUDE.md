...
4. `npm test` — vitest over `test/` (21 suites: main-side parser/indexer/rename/customTitle/windowState/codexParser/codexThreadsDb/codexSessionIndex/codexRename/bootCommand/agentEnv/updater-core + shared messageCount + renderer-lib liveness/theme/navHistory/pins/clipboard/findMatches/messageGroups/codeLang). The renderer UI is not unit-tested.
