...
4. `npm test` — vitest over `test/` (16 suites: main-side parser/indexer/rename/customTitle/windowState/codexParser/codexThreadsDb/codexRename/updater-core + renderer-lib liveness/theme/navHistory/pins/clipboard/findMatches/messageGroups). The renderer UI is not unit-tested.
